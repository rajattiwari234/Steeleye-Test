...
{"asset_class": "Equity", "counterparty": "Zerodha", "instrument_id": "AAPL", "instrument_name": "Stock", "trade_date_time": "11111111", "trade_details": "", "trade_id": "1234", "trader": "XXX", "buysellindicator": "BUY", "price": "123", "quantity": "22"},
]
...
@app.get("/trades")
async def read_cust_trade(counterparty: str, instrument_id: str, instrument_name: str, trader: str):
    return trades